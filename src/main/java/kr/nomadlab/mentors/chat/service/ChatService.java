...
public interface ChatService {
    ...
    public void inviteChatRoom(Long mno, String roomId, String nickname); // 채팅방 초대
    ...
    public void removeChatMember(String roomid, Long mno, Long mbNo); // 채팅방에 나간 회원 정보 삭제
}
